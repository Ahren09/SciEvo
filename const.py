...
SUBJECT2KEYWORDS = {
    'Computer Science': {
        'large language models': ['large language models', 'large language model', 'llm', 'llms', 'gpt', 'chatgpt',
                                  'gpt4',
        ...
        'quantum computing': ['quantum algorithms', 'quantum', 'quantum computing', 'computational complexity',
                               'quantum cryptography'],
        'language models': ['bert', 'roberta', 'xlnet', 'transformer', 'transformers', 'bidirectional', 'attention',
                 'self-attention',
                 'language models'],
        ...
        'recommender systems': ['recommendation', 'recommender', 'matrix factorization', 'mf', 'cf',
        ...
        'hybrid teaching': ['hybrid teaching', 'blended learning', 'online', 'educational technology', 'pedagogical',
                            'pedagogy', 'e-learning'],
        'cognitive strategies': ['cognitive strategies', 'metacognition', 'educational psychology',
                                 'learning theories'],
    ...
    'Business': {'consumer neuroscience': ['consumer neuroscience', 'neuromarketing', 'decision making',
                 ...
                 'corporate governance': ['corporate governance', 'emerging markets', 'international',
                                          'global market', 'market regulation']},
    ...
    'COVID-19': ['covid', 'covid-19', 'sars-cov-2', 'coronavirus', 'pandemic', 'post-acute sequelae'],
    'microbiome therapeutics': ['microbiome therapeutics', 'gut-brain axis', 'probiotics', 'microbial ecology'],
    'Immunotherapy': ['car', 't-cell therapy', 'immunotherapy', 'adoptive cell transfer', 'lymphoma treatment',
                      'biotechnology'],
    ...
    'Cosmology': ['ligo', 'gravitational waves', 'astrophysics', 'cosmology']}, 'Engineering': {
