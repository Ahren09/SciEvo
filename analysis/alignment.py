...
def explicit_intersection_align(embed1, embed2, restrict_context=True):
    ...
    return embed1.get_subembed(common_vocab, restrict_context=restrict_context), embed2.get_subembed(common_vocab,
...
def intersection_align(embed1, embed2, post_normalize=True):
    ...
    return Embedding(newvecs1, common_vocab, normalize=post_normalize), Embedding(newvecs2, common_vocab,
